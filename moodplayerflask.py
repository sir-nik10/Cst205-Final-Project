...
@app.route('/template')
def template():
	return render_template('cvwebpage.html', name='Josephina Meagan McStallion', faves=meagans_faves, img='meagan.jpg', site='meagan-mcstalion.me.com', p='she', pp='her')

@app.route('/response/<mood>')
def response_page(mood):
	return render_template('cvwebpage.html', name='Josephina Meagan McStallion', mood=mood, faves=meagans_faves, img='meagan.jpg', site='meagan-mcstalion.me.com', p='she', pp='her')